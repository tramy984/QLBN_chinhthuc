...
namespace QLBN
{
    public partial class fkhoaRHM : Form
    {
        ...
        {
            ListBenhNhan.LoadDataFromSelectedRow(dtgvkhoaRHM, txbid, txbhoten, cbGT, DtNgaySinh, txbCCCD, txbBHYT, txbSDT, NgayNhapVien, NgayRaVien, txbkhoa, txbBacsi, txbYta, txbBenh, cbGB, cbLBN);
        }
        void LoadBenhNhanKhoaRHM()
        {
            string query = "SELECT * FROM dbo.Benhnhan Where MaKhoa=11";
        ...
        {
            ListBenhNhan.TimKiemBN(dtgvkhoaRHM, txbTK, "11");
        }
