...
namespace QLBN
{
    public partial class fnhi : Form
    {
        ...
        private void dtgvkhoanhi_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ListBenhNhan.LoadDataFromSelectedRow(dtgvkhoanhi, txbid, txbhoten, cbGT, DtNgaySinh, txbCCCD, txbBHYT, txbSDT, NgayNhapVien, NgayRaVien, txbkhoa, txbBacsi, txbYta, txbBenh, cbGB, cbLBN);
        }
        void LoadBenhNhanKhoaNhi()
        {
            string query = "SELECT * FROM dbo.Benhnhan Where MaKhoa=20";
        ...
        {
            ListBenhNhan.TimKiemBN(dtgvkhoanhi, txbTK, "20");
        }
