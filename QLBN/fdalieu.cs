...
namespace QLBN
{
    public partial class fdalieu : Form
    {
        ...
        {
            ListBenhNhan.LoadDataFromSelectedRow(dtgvkhoadalieu, txbid, txbhoten, cbGT, DtNgaySinh, txbCCCD, txbBHYT, txbSDT, NgayNhapVien, NgayRaVien, txbkhoa, txbBacsi, txbYta, txbBenh, cbGB, cbLBN);
        }
        void LoadBenhNhanKhoaDaLieu()
        {
            string query = "SELECT * FROM dbo.Benhnhan Where MaKhoa=21";
        ...
        {
            ListBenhNhan.TimKiemBN(dtgvkhoadalieu, txbTK, "21");
        }
